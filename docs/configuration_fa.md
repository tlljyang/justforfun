...
6. میتونید کانفیگ وارپ رو به تعداد Endpoint هایی که وارد کردید در یک فایل زیپ از قسمت Download دریافت کنید، مثلا برای استفاده در برنامه‌ی WG Tunnel یا هر بنامه‌ای که فایل کانفیگ وایرگارد رو ساپورت میکنه.
<br><br>
